    ...
    <footer className="border-t border-black/5 bg-[#f7f6f2]">
      <div className="mx-auto grid max-w-[1480px] gap-12 px-5 py-16 lg:grid-cols-[1.05fr_1.55fr_1fr] lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-6 text-black/45">A curated UK-focused store for practical home gadgets, organisation tools and small everyday upgrades.</p>
