          ...
          {STORE_CATEGORIES.map((category, index) => {
            ...
            return (
              <Link
                ...
                key={category.slug}
                className={`group overflow-hidden rounded-[var(--hf-radius-lg)] border border-black/[.06] ${category.tone} transition duration-300 hover:-translate-y-1.5 hover:shadow-[var(--hf-shadow-soft)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--hf-brand-muted)]`}
              >
                ...
                <div className="flex min-h-[190px] flex-col p-6 lg:p-7">
