...
export default function CartPage() {
  ...
  if (!cart?.items?.length) {
    return (
      <main className="min-h-[70vh] bg-[var(--hf-background)] px-5 py-16 lg:px-8 lg:py-24">
  ...
  return (
    <main className="bg-[var(--hf-background)] px-5 py-10 lg:px-8 lg:py-16">
      <div className="mx-auto max-w-[1380px]">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[minmax(0,1fr)_390px] xl:gap-16">
          ...
          <aside className="h-fit lg:sticky lg:top-28">
            <div className="rounded-[var(--hf-radius-lg)] border border-black/[.07] bg-white p-6 shadow-[0_20px_70px_rgba(34,45,37,.045)]">
              ...
              <div className="mt-6 space-y-3 text-sm">
                ...
                <div className="flex justify-between gap-4"><span className="text-black/48">Standard UK delivery</span><strong className="text-[var(--hf-brand)]">FREE</strong></div>
