...
Home placements, native whole-banner links, the three campaign destinations and the strict under-20 predicate remain unchanged. Lora is page-scoped to Home and the Under £20 collection with preload enabled; only Inter remains in the root layout. Lora replaces Cormorant Garamond at the owner's request while retaining the existing 500/600 weights and editorial scope. The --hf-font-editorial alias is rebound on .hf-editorial-scope so it resolves the page's Next font rather than inheriting a root-level Georgia fallback. Hero, section headings, the dark Featured Find heading and the destination collection heading share the editorial family. Product names, prices, navigation, fields and checkout stay in Inter.
