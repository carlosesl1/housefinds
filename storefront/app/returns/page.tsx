    ...
    <main className="bg-[var(--hf-background)] px-5 py-14 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-[1180px]">
        ...
        <div className="mt-10 grid gap-12 lg:grid-cols-[.85fr_1.15fr] lg:gap-20">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[.28em] text-[var(--hf-brand-muted)]">Housefinds returns & support</p>
            <h1 className="mt-4 text-[clamp(3.8rem,6vw,6.8rem)] font-semibold leading-[.88] tracking-[-.065em]">If something is not right,<br /><span className="text-[var(--hf-brand-muted)]">we make it right.</span></h1>
            ...
            <div className="mt-8 rounded-[var(--hf-radius-lg)] bg-[#e6eee8] p-6">
            ...
            <div className="mt-4 rounded-[var(--hf-radius-lg)] border border-[#b8cec0] bg-white p-6">
              ...
              <p className="mt-3 text-sm font-semibold text-[var(--hf-brand)]">Where appropriate, the resolution can be a replacement or a refund to the original payment method.</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <section key={title} className="rounded-[var(--hf-radius-lg)] border border-black/[.06] bg-white p-6 sm:p-7">
                <h2 className="text-xl font-semibold tracking-[-.03em]">{title}</h2>
                <p className="mt-3 text-sm leading-6 text-black/50">{copy}</p>
              </section>
            ))}

            <section className="rounded-[var(--hf-radius-lg)] border border-amber-200 bg-amber-50 p-6 sm:p-7">
            ...
            <section className="rounded-[var(--hf-radius-lg)] bg-[#172018] p-6 text-white sm:p-7">
              ...
              <a href="mailto:contact@housefindsstore.com" className="mt-5 inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-[var(--hf-ink)]"><EnvelopeIcon className="size-4" /> contact@housefindsstore.com</a>
            </section>
          </div>
        </div>
      </div>
