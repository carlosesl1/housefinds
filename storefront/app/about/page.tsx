    ...
    <main className="bg-[#fbfaf7]">
      <section className="border-b border-black/[.06] px-5 py-20 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-[1400px]">
          <p className="text-[11px] font-semibold uppercase tracking-[.28em] text-[#557562]">About Housefinds</p>
          <div className="mt-5 grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:items-end">
            <h1 className="text-[clamp(4rem,7vw,8rem)] font-semibold leading-[.86] tracking-[-.07em] text-[#101622]">Useful things.<br /><span className="text-[#557562]">Less clutter.</span></h1>
        ...
        <div className="mx-auto grid max-w-[1400px] gap-12 lg:grid-cols-[.75fr_1.25fr] lg:gap-20">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <article key={title} className="rounded-[28px] bg-[#f0f2ed] p-6">
      ...
      <section className="bg-[#172018] px-5 py-20 text-white lg:px-8 lg:py-24">
        <div className="mx-auto flex max-w-[1400px] flex-col justify-between gap-8 lg:flex-row lg:items-end">
          ...
          <div className="flex shrink-0 flex-wrap gap-3"><Link href="/shop" className="inline-flex h-13 items-center gap-2 rounded-full bg-[#dce8df] px-6 font-semibold text-[#172018]">Browse products <ArrowRightIcon className="size-4" /></Link><Link href="/search" className="inline-flex h-13 items-center rounded-full border border-white/20 px-6 font-semibold">Search</Link></div>
        </div>
      </section>
    </main>
  )
