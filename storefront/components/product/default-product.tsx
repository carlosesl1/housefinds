    ...
    <main className="bg-[var(--hf-background)]">
      ...
      >
        ...
        <div className="hf-container relative pb-16 pt-5 lg:pb-24 lg:pt-7">
          <nav className="mb-6 flex flex-wrap items-center gap-2 text-xs text-black/38 sm:text-sm" aria-label="Breadcrumb">
          ...
          <div className="grid gap-8 xl:grid-cols-[1.12fr_.88fr] xl:items-start xl:gap-14">
            ...
            <aside className="xl:sticky xl:top-24 xl:self-start">
              ...
              <div className="hf-purchase-shell overflow-hidden rounded-[var(--hf-radius-lg)] border border-white/65 bg-white/88 shadow-[0_28px_85px_rgba(29,42,34,.105)] backdrop-blur-xl">
                <div className="relative p-6 pb-5 sm:p-7 sm:pb-6 lg:p-8 lg:pb-7">
                  <div className="pointer-events-none absolute -right-10 -top-10 size-40 rounded-full bg-[var(--hf-brand-soft)]/55 blur-3xl" />
                  <div className="relative">
                    ...
                    <h1 className="mt-4 max-w-[720px] text-[clamp(2.35rem,3.1vw,3.35rem)] font-semibold leading-[.98] tracking-[-.045em] text-[var(--hf-ink)]">{name}</h1>
                    <p className="mt-4 max-w-xl text-[16px] leading-7 text-black/52 sm:text-[17px]">{tagline}</p>
                ...
                <div className="border-t border-black/[.055] bg-[#fcfcf9]/90 p-5 sm:p-6 lg:p-7">
          ...
          <div className="mx-auto max-w-[1200px] px-5 sm:px-6">
            <div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr] lg:gap-16">
              <div>
                ...
                <p className="mt-4 max-w-sm text-sm leading-6 text-black/45">Key options and verified listing details, presented in a way that is easy to scan.</p>
              </div>
              <dl className="overflow-hidden rounded-[var(--hf-radius-lg)] border border-black/[.065] bg-white/88 shadow-[0_20px_58px_rgba(29,42,34,.065)] backdrop-blur-sm">
                {detailRows.map((row, index) => (
                  <div key={`${row.label}-${index}`} className={`grid gap-3 px-6 py-5 sm:grid-cols-[180px_1fr] sm:items-start sm:px-7 ${index > 0 ? 'border-t border-black/[.065]' : ''}`}>
                    <dt className="pt-1 text-sm font-semibold text-black/45">{row.label}</dt>
